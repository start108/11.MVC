...
<body>
	...
	<div class="container">
		...
		<div class="page-header">
	       ...
	       <h5 class="text-muted">상품 <strong class="text-danger">상세조회 </strong>페이지 입니다.</h5>
	    </div>
		...
		<div class="row">
			...
			<div class="col-xs-8 col-md-4">${priceformat}&nbsp;원</div>
		</div>
		...
		<div class="form-group">
		    <div class="col-sm-offset-4  col-sm-4 text-center">
			  ...
			  <a class="btn btn-primary btn" href="#" role="button">구 &nbsp;매</a>
		    </div>
		</div>
